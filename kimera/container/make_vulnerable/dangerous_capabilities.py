...
class DangerousCapabilitiesExploit(BaseExploit):
    ...
    def get_default_service(self) -> str:
        """Get the default service for dangerous capabilities exploit."""
    ...
    def demonstrate(self) -> ExploitResult:
        ...
        try:
            ...
            if "Has ALL capabilities" in result:
                evidence.append("Container has ALL Linux capabilities (000001ffffffffff)")
        ...
        try:
            ...
            if "SYS_ADMIN capability active" in result:
                evidence.append("SYS_ADMIN capability confirmed - can mount filesystems")
